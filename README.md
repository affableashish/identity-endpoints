...
<img width="650" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/4d0361cb-b308-46d6-b307-9d05b07be1ad">
...
<img width="250" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/3700efb7-7bf6-4f3a-9720-5c46e4ef4fd6">
...
````
<img width="750" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/30e54bad-ea90-430f-a073-84c0d1aa81c8">
...
````
<img width="700" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/9c5a9f0c-9f13-4c3e-bd4c-61a9a23cf7a4">

<img width="200" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/58206735-d384-40f4-bb96-82befaaf9f3b">

## Add authorization to API:
<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/4f5f6cd7-b06a-4508-af63-a476064cd7e1">                   

<img width="450" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/fccd94bd-d535-4376-9e73-079dadbe9386">                    

<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/e1dab81e-b3be-4d8d-922b-35c33525f69a">

## Take it for a test ride:
<img width="400" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/fefe5a54-d2e9-4bfd-886d-34222aae1ff4">

## Add the Identity API endpoints:
Use prefix of `"/identity"` by using `MapGroup`.

<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/e631dbe0-6846-460c-a506-6d170faea12b">

Check out Swagger UI:

<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/a627fa7f-f10b-4e82-90a5-8caa16ce5872">

## Test it using Rider's built-in HttpClient support:
<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/d8de0b98-b293-45e5-b0e7-d561cc734002">

Generate Request:

<img width="350" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/2ea76b1c-37af-4619-901c-c14ad2670152">

Result:

<img width="800" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/c52baf79-1421-454e-8a6f-fd0693f2325b">

## Registering a new user:
Using `IdentityWebAPI.http` file that was created by default when I created the API.

<img width="800" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/9c04fc69-71ac-4728-8009-8face8603fdd">

## Login and retrieve tokens:
<img width="450" alt="image" src="https://github.com/akhanalcs/blazor-identity-api/assets/30603497/aa55a114-9961-4324-908b-5c795e027dcd">
